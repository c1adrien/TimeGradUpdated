...
from gluonts.torch.distributions.distribution_output import DistributionOutput  #erreur qui était bien présente ds le nouveau code !!!
from gluonts.torch.modules.lambda_layer import LambdaLayer
from modules import MeanScaler, NOPScaler
